function [J_full, dfdGts_full, dfdGads_full] = computeDiffODEInt(y, x, Ptot, T, G_ts_111, G_ads_111, EZPEc_gas_111, lnQ_gas_111, LI_111_H)

    %% 'Import CasADi suite from main script'
    import casadi.*
