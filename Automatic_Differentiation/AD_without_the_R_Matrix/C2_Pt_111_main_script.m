...
%% 'Add CasADi to path'
addpath('/home/x-bamidele/per_bin/casadi-3.7.0-linux64-matlab2018b/')
...
%% 'Add Qs initial to initial coverages y'
y0 = [x0 ; Q_Gts0; Q_Gads0] ;
...
[t,y] = ode15s(@(t,y)C2_Pt_111_Composite_ODE_function(t, y, x, Ptot, T, G_ts_111, G_ads_111, EZPEc_gas_111, lnQ_gas_111, LI_111_H),[0, run_time],y0,optode) ;
...
for jk = 1:length(t)
    ...
    %% 'Extract Q_Gts and Q_Gads matrices from y solution and reshape'
