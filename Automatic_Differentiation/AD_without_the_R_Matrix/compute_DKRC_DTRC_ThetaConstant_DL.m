function [lnTOF_Ethane, lnTOF_Methane, dlnTOF_E_dGts_thetaconst, dlnTOF_M_dGts_thetaconst, dlnTOF_E_dGads_thetaconst, dlnTOF_M_dGads_thetaconst, dlnTOF_E_dtheta_Gconst,  dlnTOF_M_dtheta_Gconst] = compute_DKRC_DTRC_ThetaConstant_DL(y, dl_y, x, dl_x, Ptot, G_ts_111, dl_G_ts_111, G_ads_111, dl_G_ads_111, EZPEc_gas_111, dl_EZPEc_gas_111, lnQ_gas_111, dl_lnQ_gas_111, LI_111_H, dl_LI_111_H)
    ...
    dl_dG_act_111_LI = dlarray(zeros(length(dl_G_ts_111), 1)) ;
    dl_dG_rxn_111_LI = dlarray(zeros(length(dl_G_ts_111), 1)) ;
    ...
    %% 'Gasphase adsorption-desorption reactions: for H2, remember that slab and product energy is squared'
    ...
    for i = 1:length(prod_idx)
        if i == length(prod_idx)
            ...
            dG_rxn_111_LI(26 + i) = dG_rxn_111(26 + i) + 2 * ((LI_111_H(prod_idx(i)) - LI_111_H(17)) * y(16)) ; % '2 * G_ads_111_LI(prod_idx(i)) - (EZPEc_gas_111(i) - kb * T * lnQ_gas_111(i)) - 2 * G_ads_111_LI(17) ;'
            dl_dG_rxn_111_LI(26 + i) = dl_dG_rxn_111(26 + i) + 2 * ((dl_LI_111_H(prod_idx(i)) - dl_LI_111_H(17)) * dl_y(16)) ; % '2 * dl_G_ads_111_LI(prod_idx(i)) - (dl_EZPEc_gas_111(i) - kb * T * dl_lnQ_gas_111(i)) - 2 * dl_G_ads_111_LI(17) ;'
            ...
            dG_rxn_111_LI(26 + i) = dG_rxn_111(26 + i) + ((LI_111_H(prod_idx(i)) - LI_111_H(17)) * y(16)) ; % 'G_ads_111_LI(prod_idx(i)) - (EZPEc_gas_111(i) - kb * T * lnQ_gas_111(i)) - G_ads_111_LI(17) ;'
            dl_dG_rxn_111_LI(26 + i) = dl_dG_rxn_111(26 + i) + ((dl_LI_111_H(prod_idx(i)) - dl_LI_111_H(17)) * dl_y(16)) ; % 'dl_G_ads_111_LI(prod_idx(i)) - (dl_EZPEc_gas_111(i) - kb * T * dl_lnQ_gas_111(i)) - dl_G_ads_111_LI(17) ;'
    ...
    %% 'Deep Learning Array of Overall Rate Expressions'
    ...
    Ethane_conv_TOF = abs(dl_r111(27)) ; % 'abs(dl_r111(1) + dl_r111(2)) ;'
    Methane_prod_TOF = -dl_r111(30) ; % '-dl_r111(23) ;'
    
    % 'Ethane conversion TOF and Methane prodcution TOF'
    lnTOF_Ethane = log(Ethane_conv_TOF) ;
