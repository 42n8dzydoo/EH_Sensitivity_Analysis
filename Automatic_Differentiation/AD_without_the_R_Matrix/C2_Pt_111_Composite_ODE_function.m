function G = C2_Pt_111_Composite_ODE_function(t, y, x, Ptot, T, G_ts_111, G_ads_111, EZPEc_gas_111, lnQ_gas_111, LI_111_H)
    format long
    ...
    %% 'Initialized ODE for coverages only'
    F = zeros(17,1) ;
    ...
    F(7) = r111(10) + r111(14) - (r111(16) + r111(17)) ; %r[10]
    ...
    %% 'Free site balances as DAE'
    F(17) = 1 - y(1) - y(2) - 2 * y(3) - 3 * y(4) - 2 * y(5) - 3 * y(6) - 3 * y(7) - 3 * y(8) - 3 * y(9) - 4 * y(10) - y(11) - y(12) - 2 * y(13) - 3 * y(14) - 3 * y(15) - y(16) - y(17) ;
    
    %% 'Get Jacobian and time integrations of F'
    % 'dfdy is the jacobian'
    [dfdy, dfdGts, dfdGads] = computeDiffODEInt(y(1:17), x, Ptot, T, G_ts_111, G_ads_111, EZPEc_gas_111, lnQ_gas_111, LI_111_H) ;
    ...
    %% 'Initialize composite ODE equation i.e F with Realtional equations'
    G = zeros(length(y),1) ;
    
    %% 'Composite ODE equations'
