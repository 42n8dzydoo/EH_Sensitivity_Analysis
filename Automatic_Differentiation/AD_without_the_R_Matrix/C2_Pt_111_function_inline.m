function G = C2_Pt_111_function_inline(t, y, x, Ptot, T, G_ts_111, G_ads_111, EZPEc_gas_111, lnQ_gas_111, LI_111_H)
    format long
    ...
    [dfdy, dfdGts, dfdGads] = computeODEint(y(1:17), x, Ptot, T, G_ts_111, G_ads_111, EZPEc_gas_111, lnQ_gas_111, LI_111_H) ;
