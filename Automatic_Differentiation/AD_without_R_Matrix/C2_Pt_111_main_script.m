...
% 'Initialize Q_Gts0 and Q_Gads0 and columnize them'
Q_Gts0 = zeros(length(G_ts_111)*length(x0), 1) ;
Q_Gads0 = zeros(length(G_ads_111)*length(x0), 1) ;

%% 'Concatenate theta0, and columnized Q_Gts0 and Q_Gads0'
...
for jk = 1:length(t)
    ...
    % 'Retrieve Q_Gts and Q_ads in their original shape from the segmented column vectors'
